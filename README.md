...
<div style="display: flex; justify-content: space-between;">
  <figure style="text-align: center; width: 20%;">
    ...
    <figcaption style="font-size: 5px;">100 Simulated Missions</figcaption>
  </figure>
  <figure style="text-align: center; width: 20%;">
    ...
    <figcaption style="font-size: 5px;">1 Simulated Mission</figcaption>
  </figure>
  <figure style="text-align: center; width: 20%;">
    ...
    <figcaption style="font-size: 5px;">100 Simulated Missions Conventional</figcaption>
  </figure>
</div>
